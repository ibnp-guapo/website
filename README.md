...
- [x] [SPEC-WDLC-F4: Views Blade da Home, Sobre e Contato](docs/specs/09-views-blade-home-sobre-contato.md) (Issue #9)
- [x] [SPEC-WDLC-F5: Suíte PHPUnit e Acessibilidade WCAG 2.1 AA](docs/specs/10-suite-testes-phpunit-acessibilidade.md) (Issue #10)
