...
@section('content')
    <!-- Barra de Contexto Legal e Ações (Stitch Warm Fellowship) -->
    <div class="bg-gradient-to-b from-surface-cream-light via-[#FFFDF9] to-surface-cream-light border-b border-outline-variant/30 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <!-- Botões de Ação: Download XML & Imprimir -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <aside class="lg:col-span-4 bg-surface-pure rounded-3xl border border-outline-variant/30 p-6 elevation-warm-1 lg:sticky lg:top-24 lg:max-h-[calc(100vh-8rem)] lg:overflow-y-auto">
                <div class="mb-5">
                    ...
                    <div class="relative">
                        <input type="text" id="search-input" placeholder="Ex: diretoria, eleição, Guapó..." class="w-full px-4 py-2.5 text-xs rounded-xl border border-outline-variant/40 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-surface-cream-light text-on-surface transition">
